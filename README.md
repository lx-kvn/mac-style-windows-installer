...
The same wizard produces both. The choice shows up in two places your users
and you actually look at — the install destination, and the form itself:
...
同一套精靈兩種都做得出來。選了哪一種，會反映在兩個真的會被看到的地方——
安裝目的地，以及設定表單本身：
