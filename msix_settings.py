...
#
# **變更這個值之前先回頭看 ADR-0010 的決定三**（docs/adr/0010-msix-file-
# association-icons-must-be-png.md）：檔案關聯圖示之所以限定 PNG，理由是
# 接受 ICO 的那個清單宣告所需的 Windows 版本遠高於這裡宣告的最低版本。
# 這個值一旦調高，該限制的前提就可能不再成立，那條決定要重新評估。
